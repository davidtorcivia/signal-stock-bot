...
# Note: Hourly data has overnight gaps that cause ugly chart lines
# Using daily data for most periods - cleaner visualization
PERIOD_MAPPINGS = {
    "1d": ("1d", "5m"),      # 1 day, 5-min bars (~78 points)
    "5d": ("5d", "30m"),     # 5 days, 30-min bars (~65 points)
    "1w": ("5d", "30m"),     # 1 week (alias)
    "1m": ("1mo", "1d"),     # 1 month, daily bars (~22 points)
    "3m": ("3mo", "1d"),     # 3 months, daily (~65 points)
    "6m": ("6mo", "1d"),     # 6 months, daily (~130 points)
